  ...
  return (
    <div className="App">
      ...
      <BrowserRouter>
        <MyNavbar/>
        <Routes>
          <Route path="/" element={<Home url='https://api.jikan.moe/v4/top/anime' value='home' />} />
          <Route path="/page/:id" element={<Home url='https://api.jikan.moe/v4/top/anime' value='home'/>} />
